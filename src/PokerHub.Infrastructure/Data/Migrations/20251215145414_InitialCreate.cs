        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BlockCheckInWithDebt = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false, defaultValue: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PixKeyType = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BuyIn = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    StartingStack = table.Column<int>(type: "int", nullable: false),
                    RebuyValue = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true),
                    RebuyStack = table.Column<int>(type: "int", nullable: true),
                    RebuyLimitLevel = table.Column<int>(type: "int", nullable: true),
                    RebuyLimitMinutes = table.Column<int>(type: "int", nullable: true),
                    RebuyLimitType = table.Column<int>(type: "int", nullable: false),
                    AddonValue = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true),
                    AddonStack = table.Column<int>(type: "int", nullable: true),
                    PrizeStructure = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    Status = table.Column<int>(type: "int", nullable: false),
                    CurrentLevel = table.Column<int>(type: "int", nullable: false),
                    TimeRemainingSeconds = table.Column<int>(type: "int", nullable: true),
                    CurrentLevelStartedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BreakDescription = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BlindLevels", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BlindLevels_Tournaments_TournamentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Payments_Players_FromPlayerId",
                        column: x => x.FromPlayerId,
                        principalTable: "Players",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Payments_Players_ToPlayerId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Prize = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    EliminatedByPlayerId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BlindLevels_TournamentId_Order",
                table: "BlindLevels",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Payments_FromPlayerId",
                table: "Payments",
                column: "FromPlayerId");

            migrationBuilder.CreateIndex(
                name: "IX_Payments_ToPlayerId",
                table: "Payments",
                column: "ToPlayerId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TournamentPlayers_EliminatedByPlayerId",
                table: "TournamentPlayers",
                column: "EliminatedByPlayerId");
