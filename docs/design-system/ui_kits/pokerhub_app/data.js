/* PokerHub UI kit — shared fake data (Liga dos Amigos). */
window.PH_DATA = {
  league: { id: 'amigos', name: 'Liga dos Amigos', season: 'Temporada 3', members: 11, live: true },
  // All leagues the user belongs to — for the lobby / switcher.
  leagues: [
    ...
    { id: 'domingo',    name: 'Clube de Domingo',    suit: '♥', season: 'Temporada 2', members: 14, tournaments: 9,  role: 'player',    organizer: 'Marcos Vale', live: false, next: 'Dom · 16h' },
    { id: 'varzea',     name: 'Várzea Poker Tour',   suit: '♦', season: 'Temporada 4', members: 22, tournaments: 18, role: 'player',    organizer: 'Téo Brandão', live: true,  liveName: 'Etapa 12 · Final' },
  ],
  tournament: {
  ...
  // Premiação do torneio ao vivo — já descontada a caixinha (10% de R$ 4.800 = R$ 480).
  prizes: [
    { position: 1, amount: 2160, pct: 50 },
    { position: 2, amount: 1296, pct: 30 },
    { position: 3, amount: 864, pct: 20 },
  ],
  liveCaixinha: 480,
  ...
  table: [
    ...
    { id: 'lena', name: 'Lena Costa', nick: 'lena', status: 'out', place: 7, rebuys: 1, addons: 0, by: 'Ana Reis' },
    { id: 'theo', name: 'Theo Alves', nick: 'theo', status: 'out', place: 8, rebuys: 0, addons: 0, by: 'Bruno Lima' },
    { id: 'nina', name: 'Nina Rocha', nick: 'nina', status: 'out', place: 9, rebuys: 2, addons: 0, by: 'Caio Souza' },
  ],
  ...
  pagamentos: {
    ...
    // Despesas da noite (lanches etc.) — rateadas nos pagamentos, fora do ranking.
    despesas: [
      { id: 'e1', desc: 'Pizza e bebidas', paidBy: 'Ana Reis', total: 160, splitCount: 4, each: 40, among: 'Theo, Igor, Lena e Rafa' },
    ],
    // Cada transferência agrega Poker + Despesas do mesmo par devedor → credor.
    transfers: [
      { id: 't1', from: 'Theo Alves',   to: 'Ana Reis',   amount: 350, type: 'Poker',    pix: 'ana.reis@pix.com',  status: 'pending',
        parts: [{ type: 'Poker', amount: 310 }, { type: 'Despesas', amount: 40, desc: 'Pizza e bebidas' }] },
      { id: 't2', from: 'Igor Pádua',   to: 'Ana Reis',   amount: 280, type: 'Poker',    pix: 'ana.reis@pix.com',  status: 'pending',
        parts: [{ type: 'Poker', amount: 240 }, { type: 'Despesas', amount: 40, desc: 'Pizza e bebidas' }] },
      { id: 't3', from: 'Lena Costa',   to: 'Caio Souza', amount: 240, type: 'Poker',    pix: '11 98765-4321',     status: 'pending',
        parts: [{ type: 'Poker', amount: 240 }] },
      { id: 't4', from: 'Lena Costa',   to: 'Ana Reis',   amount: 40,  type: 'Despesas', pix: 'ana.reis@pix.com',  status: 'pending',
        parts: [{ type: 'Despesas', amount: 40, desc: 'Pizza e bebidas' }] },
      { id: 't5', from: 'Theo Alves',   to: 'Caio Souza', amount: 50,  type: 'Poker',    pix: '11 98765-4321',     status: 'pending',
        parts: [{ type: 'Poker', amount: 50 }] },
      { id: 't6', from: 'Rafa Nunes',   to: 'Bruno Lima', amount: 80,  type: 'Poker',    pix: 'brunolima@pix.com', status: 'pending',
        parts: [{ type: 'Poker', amount: 80 }] },
      { id: 't7', from: 'Rafa Nunes',   to: 'Ana Reis',   amount: 40,  type: 'Despesas', pix: 'ana.reis@pix.com',  status: 'pending',
        parts: [{ type: 'Despesas', amount: 40, desc: 'Pizza e bebidas' }] },
      { id: 't8', from: 'Rafa Nunes',   to: 'Caixinha',   amount: 40,  type: 'Caixinha', pix: 'Pote acumulado',    status: 'pending',
        parts: [{ type: 'Caixinha', amount: 40 }] },
      { id: 't9', from: 'Duda Martins', to: 'Caixinha',   amount: 60,  type: 'Caixinha', pix: 'Pote acumulado',    status: 'pending',
        parts: [{ type: 'Caixinha', amount: 60 }] },
    ],
  },
  ranking: [
    { position: 1, name: 'Ana Reis',     nick: 'a_reis', sub: '8 vitórias · 62% ITM', profit: 1840, delta: 0,
      tournaments: 9, wins: 8, second: 0, third: 1, itm: 62, roi: 112.3, winRate: 89, avgPos: 1.8,
      buyIns: 1640, prizes: 3480, best: 980, worst: -100,
      recent: [{ name: 'Torneio da Sexta', date: '24/06', pos: 1, total: 9, invest: 50, prize: 980, profit: 930 },
    ...
    { position: 2, name: 'Caio Souza',   nick: 'caio', sub: '5 vitórias · 55% ITM', profit: 1120, delta: 1,
      tournaments: 9, wins: 5, second: 2, third: 1, itm: 55, roi: 71.8, winRate: 56, avgPos: 2.6,
      buyIns: 1560, prizes: 2680, best: 720, worst: -160,
      recent: [{ name: 'Torneio da Sexta', date: '24/06', pos: 2, total: 9, invest: 50, prize: 260, profit: 210 },
    ...
    { position: 3, name: 'Bruno Lima',   nick: 'brunin', sub: '3 vitórias · 48% ITM', profit: 640, delta: -1,
      tournaments: 8, wins: 3, second: 3, third: 0, itm: 48, roi: 44.4, winRate: 38, avgPos: 3.1,
      buyIns: 1440, prizes: 2080, best: 520, worst: -200,
      recent: [{ name: 'Torneio da Sexta', date: '24/06', pos: 4, total: 9, invest: 100, prize: 0, profit: -100 },
    ...
    { position: 4, name: 'Duda Martins', nick: 'duda', sub: '2 vitórias · 41% ITM', profit: 120, delta: 1,
      tournaments: 8, wins: 2, second: 1, third: 2, itm: 41, roi: 8.6, winRate: 25, avgPos: 4.0,
      buyIns: 1400, prizes: 1520, best: 380, worst: -150,
      recent: [{ name: 'Torneio da Sexta', date: '24/06', pos: 3, total: 9, invest: 50, prize: 130, profit: 80 },
               ...
               { name: 'Mata-mata', date: '24/05', pos: 1, total: 7, invest: 50, prize: 320, profit: 270 }] },
    { position: 5, name: 'Rafa Nunes',   nick: 'rafa', sub: '1 vitória · 38% ITM', profit: -260, delta: -1,
      tournaments: 8, wins: 1, second: 1, third: 1, itm: 38, roi: -18.6, winRate: 13, avgPos: 4.8,
      buyIns: 1400, prizes: 1140, best: 280, worst: -200,
      recent: [{ name: 'Torneio da Sexta', date: '24/06', pos: 5, total: 9, invest: 50, prize: 0, profit: -50 },
    ...
    { position: 6, name: 'Igor Pádua',   nick: 'igor', sub: '0 vitórias · 33% ITM', profit: -540, delta: 0,
      tournaments: 9, wins: 0, second: 1, third: 1, itm: 33, roi: -33.8, winRate: 0, avgPos: 5.6,
      buyIns: 1600, prizes: 1060, best: 220, worst: -250,
      recent: [{ name: 'Torneio da Sexta', date: '24/06', pos: 6, total: 9, invest: 80, prize: 0, profit: -80 },
